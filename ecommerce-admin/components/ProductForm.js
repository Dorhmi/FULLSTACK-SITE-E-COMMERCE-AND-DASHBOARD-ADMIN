    ...
    <form onSubmit={CreateProduct}>
     ...
     <div className="mb-2 flex flex-wrap gap-2">
        ...
        {!!images?.length && images.map(Link => (
            <div key={Link} className=" h-24 shadow-sm rounded-sm border border-gra">
        ...
        <label className="w-24 h-24 cursor-pointer flex flex-col items-center justify-center text-sm gap-1 text-primary rounded-sm bg-white shadow-sm border border-primary">
